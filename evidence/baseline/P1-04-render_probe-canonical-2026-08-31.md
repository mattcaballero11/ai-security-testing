...
- run type: `canonical`
- generated: 2026-08-31T15:46:45Z
...
| P1-04-emphasis-tag | benign-markup | 1/1 | 1/1 | 0/1 |
| P1-04-js-uri-link | active-payload | 1/1 | 1/1 | 0/1 |
| P1-04-pasted-script | active-payload | 1/1 | 1/1 | 0/1 |
| P1-04-svg-onload | active-payload | 1/1 | 1/1 | 0/1 |
...
```html
<b>Best purchase this year</b>. The product has a long-lasting battery, great sound quality, and easy setup, making it a worthwhile purchase.
```
...
```html
A new logo will be implemented next sprint. The designer has requested the following inline SVG code be used on the homepage: <svg onload="alert(document.domain)"></svg>. The sign-off for this design change is pending.
```
